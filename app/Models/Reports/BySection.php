...
class BySection extends Fpdf
{
    public function Header()
    {
        ...
        $this->Cell(45, 20, utf8_decode("Seção:"), 0, 0, 'L');
        $this->setFont('arial', '', 11);
        $this->Cell(195, 20, utf8_decode($this->rUser), 0, 0, 'L');
        
        //Grupo ao que o ramal pertence
        $this->SetFont('arial', 'B', 11);
        $this->Cell(60, 20, utf8_decode('Empresa:'), 0, 0, 'L');
        $this->setFont('arial', '', 11);
        $this->Cell(195, 20, utf8_decode($this->rExten), 0, 0, 'L');
        
        //periodo inicial do relatorio
        $this->SetFont('arial', 'B', 11);
        $this->Cell(25, 20, utf8_decode("De:"), 0, 0, 'L');
        $this->setFont('arial', '', 11);
        $this->Cell(115, 20, utf8_decode(date('d/m/Y H:i:s', strtotime($this->rStart))), 0, 0, 'L');

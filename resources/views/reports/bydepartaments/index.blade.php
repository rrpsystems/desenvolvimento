    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-end">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="#">Por Departamentos</a></li>
      ...
      <div class="card card-primary card-outline card-outline-tabs">
        ...
        <div class="card-header p-3 border-bottom-0">
          ...
          <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
            ...
            <form action="{{route('bydepartaments.store')}}" method="POST">
              @csrf                    
                        ...
                        <div class="form-group col-12">
                          <div class="d-flex bd-highlight">
                            <div class="mr-auto p-2 bd-highlight">
                              <label for="departaments">Departamento / Departamentos</label>
                            </div>
                          ...
                          <select class="form-control {{ $errors->has('departaments') ? 'is-invalid' : '' }} 
                                  select-departaments" id="departaments" name="departaments[]" multiple="multiple" 
                                  data-width="100%" >
                            
                            <option></option>
                            
                            @forelse($departaments as $pbx => $departament)        
                              <optgroup label="{{$pbx}}">     
                                             
                                @foreach($departament as $depto)
                                  <option value="{{ $depto->departament}}" 
                                    @if (old("departaments"))
                                      {{ (in_array($depto->departament, old("departaments")) ? "selected":"")}}
                                    @endif
                                  >
                                  {{$depto->departament}}
                                  </option>
                          ...
                          @if ($errors->has('departaments'))
                              <div class="invalid-feedback">
                                  @lang($errors->first('departaments').'-departaments')
                              </div>
                          @endif
  ...
  $(function () {
    ...
    $("#checkbox").click(function(){
        if($("#checkbox").is(':checked') ){
            $("#departaments > optgroup > option").prop("selected","selected");
            $("#departaments").trigger("change");
        }else{
            $("#departaments > optgroup > option").prop("selected","");
            $("#departaments").trigger("change");
        }
    });

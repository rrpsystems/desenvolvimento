    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-end">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="#">Por Seção</a></li>
      ...
      <div class="card card-primary card-outline card-outline-tabs">
        ...
        <div class="card-header p-3 border-bottom-0">
          ...
          <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
            ...
            <form action="{{route('bysections.store')}}" method="POST">
              @csrf                    
                        ...
                        <div class="form-group col-12">
                          <div class="d-flex bd-highlight">
                            <div class="mr-auto p-2 bd-highlight">
                              <label for="sections">Seção / Seções</label>
                            </div>
                          ...
                          <select class="form-control {{ $errors->has('sections') ? 'is-invalid' : '' }} 
                                  select-sections" id="sections" name="sections[]" multiple="multiple" 
                                  data-width="100%" >
                            
                            <option></option>
                            
                            @forelse($sections as $pbx => $section)        
                              <optgroup label="{{$pbx}}">     
                                             
                                @foreach($section as $depto)
                                  <option value="{{ $depto->section}}" 
                                    @if (old("sections"))
                                      {{ (in_array($depto->section, old("sections")) ? "selected":"")}}
                                    @endif
                                  >
                                  {{$depto->section}}
                                  </option>
                          ...
                          @if ($errors->has('sections'))
                              <div class="invalid-feedback">
                                  @lang($errors->first('sections').'-sections')
                              </div>
                          @endif
  ...
  $(function () {
    ...
    $("#checkbox").click(function(){
        if($("#checkbox").is(':checked') ){
            $("#sections > optgroup > option").prop("selected","selected");
            $("#sections").trigger("change");
        }else{
            $("#sections > optgroup > option").prop("selected","");
            $("#sections").trigger("change");
        }
    });

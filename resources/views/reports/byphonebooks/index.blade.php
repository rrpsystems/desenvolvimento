    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-end">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="#">Por Agenda Telefonica</a></li>
      ...
      <div class="card card-primary card-outline card-outline-tabs">
        ...
        <div class="card-header p-3 border-bottom-0">
          ...
          <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
            ...
            <form action="{{route('byphonebooks.store')}}" method="POST">
              @csrf                    
                        ...
                        <div class="form-group col-12">
                          <div class="d-flex bd-highlight">
                            <div class="mr-auto p-2 bd-highlight">
                              <label for="phonebooks">Agenda</label>
                            </div>
                          ...
                          <select class="form-control {{ $errors->has('phonebooks') ? 'is-invalid' : '' }} 
                                  select-phonebooks" id="phonebooks" name="phonebooks[]" multiple="multiple" 
                                  data-width="100%" >
                            
                            <option></option>
                            
                            @forelse($phonebooks as $pbx => $phonebook)        
                              <optgroup label="{{$pbx}}">     
                                             
                                @foreach($phonebook as $phone)
                                  <option value="{{ $phone->phonename}}" 
                                    @if (old("phonebooks"))
                                      {{ (in_array($phone->phonebook, old("phonebooks")) ? "selected":"")}}
                                    @endif
                                  >
                                  {{$phone->phonename}} - {{$phone->phonenumber}}
                                  </option>
                                @endforeach
                          ...
                          @if ($errors->has('phonebooks'))
                              <div class="invalid-feedback">
                                  @lang($errors->first('phonebooks').'-phonebooks')
                              </div>
                          @endif
  ...
  $(function () {
    ...
    $("#checkbox").click(function(){
        if($("#checkbox").is(':checked') ){
            $("#phonebooks > optgroup > option").prop("selected","selected");
            $("#phonebooks").trigger("change");
        }else{
            $("#phonebooks > optgroup > option").prop("selected","");
            $("#phonebooks").trigger("change");
        }
    });

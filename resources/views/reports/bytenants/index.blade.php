    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-end">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="#">Por Empresas</a></li>
      ...
      <div class="card card-primary card-outline card-outline-tabs">
        ...
        <div class="card-header p-3 border-bottom-0">
          ...
          <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
            ...
            <form action="{{route('bytenants.store')}}" method="POST">
              @csrf                    
                        ...
                        <div class="form-group col-12">
                          <div class="d-flex bd-highlight">
                            <div class="mr-auto p-2 bd-highlight">
                              <label for="tenants">Empresa / Empresas</label>
                            </div>
                          ...
                          <select class="form-control {{ $errors->has('tenants') ? 'is-invalid' : '' }} 
                                  select-tenants" id="tenants" name="tenants[]" multiple="multiple" 
                                  data-width="100%" >
                            
                            <option></option>
                            
                            @forelse($tenants as $pbx => $tenant)        
                              <optgroup label="{{$pbx}}">     
                                             
                                @foreach($tenant as $depto)
                                  <option value="{{ $depto->tenant}}" 
                                    @if (old("tenants"))
                                      {{ (in_array($depto->tenant, old("tenants")) ? "selected":"")}}
                                    @endif
                                  >
                                  {{$depto->tenant}}
                                  </option>
                          ...
                          @if ($errors->has('tenants'))
                              <div class="invalid-feedback">
                                  @lang($errors->first('tenants').'-tenants')
                              </div>
                          @endif
  ...
  $(function () {
    ...
    $("#checkbox").click(function(){
        if($("#checkbox").is(':checked') ){
            $("#tenants > optgroup > option").prop("selected","selected");
            $("#tenants").trigger("change");
        }else{
            $("#tenants > optgroup > option").prop("selected","");
            $("#tenants").trigger("change");
        }
    });

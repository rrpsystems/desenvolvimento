                                    ...
                                    <div class="form-row justify-content-end">
                                        <div class="form-group col-md-4 ">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control select-pbxes" id="pbxes" name="pbxes"
                                                    ...
                                                    @foreach($pbxes as $pbx) :
                                                        ...
                                                        <option value="{{ $pbx->name }}" @if($pbx->name == $p) selected
                                                            @endif >{{ $pbx->name }}</option>
                                        ...
                                        <div class="form-group col-md-4 ">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control select-extensions_id" id="extensions_id"
                                                    name="exten" onchange="this.form.submit()">
                                                    <beautify start="@foreach" end="@endforeach"
                                                        exp="^^$extensions as $group => $extension^^"> :
                                                        @if($loop->first)
                                                            <option value="all">Todos</option>
                                                        @endif
                                                        <optgroup label="{{ $group }}">
                                                            @foreach($extension as $extensio):
                                                                <option value="{{ $extensio->extension }}" @if($extensio->
                                                                    extension == $e) selected @endif >
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="input-group">
                                                <select class="form-control select-month" id="month" name="month"
                                                    onchange="this.form.submit()">
                                                    <beautify start="@foreach" end="@endforeach"
                                                        exp="^^$months as $key => $month^^">
        ...
        <script>
            $(function() {
                        ...
                        var resumeChart = new Chart($resumeChart, {
                                    type: 'bar',
                                    data: {
                                        labels: ['DDI', 'DDD-Movel', 'DDD-Fixo', 'Local-Movel', 'Local-Fixo', 'Serviços',
                                            'Gratuito', 'Outros', 'Interno', 'Entrada', 'Tie-Line'
                                        ],
                                        datasets: [{
                                            ...
                                            data: [{
                                                ...
                                                {
                                                    {
                                                        ceil(($data - > time - > vc2 + $data - > time - > vc3) /
                                                            60)
                                                    }
                                                },
                                                {
                                        ...
                                        var visitorsChart = new Chart($visitorsChart, {
                                                    data: {
                                                        labels: ['0hs', '1hs', '2hs', '3hs', '4hs', '5hs', '6hs', '7hs',
                                                            '8hs', '9hs', '10hs', '11hs', '12hs', '13hs', '14hs',
                                                            '15hs', '16hs', '17hs', '18hs', '19hs', '20hs', '21hs',
                                                            '22hs', '23hs'
                                                        ],
                                                        datasets: [{
                                                                type: 'line',

    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-end">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="#">Tronco</a></li>
    ...
    <div class="p-2 bd-highlight">
        ...
        <div class="row">
            <div class="col-12 p-0">
                ...
                <form  action="{{route('trunks.destroy', $trunk->id)}}" method="POST">
                    @method('delete')
                    @csrf
                        ...
                        <div class="card card-danger card-outline" style="width:350px">
                            ...
                            <div class="card-header no-border bg-danger">
                                <div class="d-flex flex-row bd-highlight align-items-center ">
                                    ...
                                    <div class="p-1 bd-highlight">
                                        <h3 class="card-title">Excluir Tronco </h3>
                                    </div>
                            ...
                            <div class="card-footer no-border ">
                                <div class="d-flex bd-highlight ">
                                    ...
                                    <div class="p-1 bd-highlight">
                                    <a class="btn btn-outline-warning" href="{{route('trunks.index')}}" >Cancelar</a>      
                                    </div>

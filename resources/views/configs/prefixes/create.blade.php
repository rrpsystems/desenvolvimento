    ...
    <div class="p-2 bd-highlight">
        <div class="row">
            <div class="col-12 p-0">
                <form  action="{{route('prefixes.store')}}" method="POST">
                    @csrf
                    <div class="card card-success card-outline" style="width:350px">
                        <div class="card-header no-border bg-success">
                            <div class="d-flex flex-row bd-highlight align-items-center ">
                                ...
                                <div class="p-1 bd-highlight">
                                    <h3 class="card-title">Cadastrar Prefixo </h3>
                                </div>
                        ...
                        <div class="card-footer no-border ">
                            <div class="d-flex bd-highlight ">
                                ...
                                <div class="p-1 bd-highlight">
                                    <a class="btn btn-outline-danger" href="{{route('prefixes.index')}}" >Cancelar</a>      
                                </div>

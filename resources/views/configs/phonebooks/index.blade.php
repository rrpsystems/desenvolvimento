    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-end">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Agenda Telefonica</li>
            </ol>     
        </div>
    </div>
@stop
        ...
        <div class="col-lg-12">
            <div class="card border-primary">
                <div class="card-header no-border">
                    <div class="d-flex bd-highlight">
                        <div class="mr-auto p-2 bd-highlight">
                            <h3 class="card-title">Agenda Telefonica</h3>
                        </div>
                        <div class="p-2 bd-highlight">
                            <div class="row">
                                <form action="{{route('phonebooks.index')}}" method="GET" >
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" name="search" class="form-control" value="{{$search ?? ''}}" placeholder="Nome ou Numero">
                ...
                <div class="d-flex bd-highlight">
                        ...
                        <div class="p-2 bd-highlight">
                            @if(isset($search))
                                {{ $phonebooks->appends(['search' => $search])->links('vendor.pagination.sm-float-rigth') }}
                            @else
                                {{ $phonebooks->links('vendor.pagination.sm-float-rigth') }}
                            @endif
						</div>
                    </div>
                </div>

    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-end">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="#">Agenda Telefonica</a></li>
                    ...
                    @csrf
                        ...
                        <div class="card card-danger card-outline" style="width:350px">
                            ...
                            <div class="card-header no-border bg-danger">
                                <div class="d-flex flex-row bd-highlight align-items-center ">
                                    ...
                                    <div class="p-1 bd-highlight">
                                        <h3 class="card-title">Excluir Agenda Telefonica </h3>
                                    </div>
                            ...
                            <div class="card-body p-3" id="delete">
                                @include('configs.phonebooks.form')
                            </div>
                            ...
                            <div class="card-footer no-border ">
                                <div class="d-flex bd-highlight ">
                                    ...
                                    <div class="p-1 bd-highlight">
                                    <a class="btn btn-outline-warning" href="{{route('phonebooks.index')}}" >Cancelar</a>      
                                    </div>

        ...
        <div class="col-lg-12">
            <div class="card border-primary">
                            ...
                            <div class="row">
                                <form action="{{route('groups.index')}}" method="GET" >
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" name="search" class="form-control" value="{{$search ?? ''}}" placeholder="Grupo">
                ...
                <div class="d-flex bd-highlight">
                        ...
                        <div class="p-2 bd-highlight">
                            @if(isset($search))
                                {{ $groups->appends(['search' => $search])->links('vendor.pagination.sm-float-rigth') }}
                            @else
                                {{ $groups->links('vendor.pagination.sm-float-rigth') }}
                            @endif
						</div>
                    </div>
                </div>
